...
public class BitLauncher {
	public static final String CLIENT_PATH = "./gamepack.jar";
		...
		try {
			{
				...
				stub.addParameter("assets", "https://s3.amazonaws.com/8BitMMO/HTMudWeb.zip");
				stub.addParameter("wmode", "opaque");
				stub.addParameter("serverName", "core.8bitmmo.net");
				stub.addParameter("serverPort", "1337");
